...
const LoginPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Removed accessToken from direct URL processing, rely on checkAuthStatus
    ...
    if (action === 'success' && userId && userEmail) {
      ...
      loginSuccess(user); // No token argument here, relying on checkAuthStatus for cookie validation
