...
export class GdmLiveAudioVisuals extends LitElement {
  ...
  // Fix: The firstUpdated method must be `protected` to override the base class method.
  ...
  // Fix: The render method must be `protected` to override the base class method.
  protected render() {
