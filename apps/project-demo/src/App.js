...
function App() {
    ...
    return (_jsxs(ThemeProvider, { theme: muiTheme, children: [_jsx(CssBaseline, {}), _jsx(Layout, { children: _jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(TtsGeneratorPage, {}) }), _jsx(Route, { path: "/login", element: _jsx(LoginPage, {}) }), " ", _jsx(Route, { path: "/auth/callback", element: _jsx(AuthCallback, {}, nanoid()) })] }) })] }));
}
export default App;
