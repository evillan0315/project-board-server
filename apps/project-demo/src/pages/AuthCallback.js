...
export const AuthCallback = () => {
    ...
    return (_jsx(Box, { className: "flex flex-col items-center justify-center min-h-[50vh]", sx: { mt: 4 }, children: currentError ? (_jsxs(Alert, { severity: "error", sx: { mb: 2 }, className: "bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200", children: ["Authentication failed: ", currentError] })) : (_jsxs(_Fragment, { children: [_jsx(CircularProgress, { className: "text-sky-600 dark:text-sky-950" }), _jsx(Typography, { variant: "h6", sx: { mt: 2 }, className: "text-gray-700 dark:text-gray-300", children: "Authenticating..." })] })) }));
};
