...
export const LoginPage = () => {
  ...
  return _jsxs(Box, {
    className:
      'flex flex-col items-center justify-center p-6 max-w-md mx-auto min-h-[calc(100vh-128px)]',
    children: [
      _jsx(Typography, {
        variant: 'h4',
        component: 'h1',
          ...
          _jsxs('form', {
            ...
            children: [
              ...
              _jsx(Button, {
                ...
                sx: { mt: 2, mb: 3 },
                disabled: loading,
                startIcon: loading ? _jsx(CircularProgress, { size: 20, color: 'inherit' }) : null,
