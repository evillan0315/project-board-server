...
export const TtsGeneratorPage = () => {
    ...
    return (_jsxs(Box, { className: "p-6 max-w-4xl mx-auto", children: [_jsx(Typography, { variant: "h4", component: "h1", sx: headerSx, children: "Gemini Text-to-Speech Generator" }), !isLoggedIn && (_jsxs(Alert, { severity: "warning", sx: { mb: 3 }, className: "bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200 flex items-center justify-between", children: ["You are not logged in. Please", ' ', _jsx(RouterLink, { to: "/login", style: { textDecoration: 'none' }, children: _jsx(Button, { variant: "contained", color: "primary", size: "small", children: "Login" }) }), ' ', "to generate speech."] })), _jsxs(Paper, { sx: paperSx, children: [_jsx(TextField, { label: "Text Prompt", multiline: true, rows: 6, fullWidth: true, value: prompt, onChange: (e) => ttsStore.setPrompt(e.target.value), margin: "normal", variant: "outlined", disabled: loading || !isLoggedIn, className: "mb-4", sx: {
                        ...
                        } }), _jsx(TextField, { label: "Language Code (e.g., en-US)", fullWidth: true, value: languageCode, onChange: (e) => ttsStore.setLanguageCode(e.target.value), margin: "normal", variant: "outlined", disabled: loading || !isLoggedIn, className: "mb-4", sx: {
                            '& .MuiOutlinedInput-root': {
                                '& fieldset': { borderColor: 'primary.light' },
                                '&:hover fieldset': { borderColor: 'primary.main' },
                                '&.Mui-focused fieldset': { borderColor: 'primary.dark' },
                            ...
                            '& .MuiInputBase-input': { color: 'text.primary' },
                                        ...
                                        '& .MuiInputLabel-root': { color: 'text.secondary' },
                                        '& .MuiInputBase-input': { color: 'text.primary' },
                                    } }), _jsx(TextField, { label: `Voice Name (e.g., Kore, Puck)`, value: speakerData.voiceName, onChange: (e) => ttsStore.updateSpeaker(speakerData.id, 'voiceName', e.target.value), variant: "outlined", size: "small", disabled: loading || !isLoggedIn, className: "flex-1", sx: {
                                        '& .MuiOutlinedInput-root': {
                                            '& fieldset': { borderColor: 'secondary.light' },
                                            '&:hover fieldset': { borderColor: 'secondary.main' },
                                            '&.Mui-focused fieldset': { borderColor: 'secondary.dark' },
                                        ...
                                        '& .MuiInputLabel-root': { color: 'text.secondary' },
                                        '& .MuiInputBase-input': { color: 'text.primary' },
                                    } }), speakers.length > 1 && (_jsx(IconButton, { onClick: () => ttsStore.removeSpeaker(speakerData.id), color: "error", disabled: loading || !isLoggedIn, "aria-label": "remove speaker", children: _jsx(DeleteIcon, {}) }))] }, speakerData.id))) }), _jsx(Button, { onClick: ttsStore.addSpeaker, startIcon: _jsx(AddIcon, {}), variant: "outlined", color: "secondary", sx: { mt: 2 }, disabled: loading || !isLoggedIn, children: "Add Speaker" }), error && (_jsx(Alert, { severity: "error", sx: { mt: 3 }, className: "bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200", children: error })), _jsx(Box, { sx: { mt: 3, display: 'flex', justifyContent: 'center' }, children: _jsx(Button, { onClick: handleGenerate, variant: "contained", sx: buttonSx, startIcon: loading ? _jsx(CircularProgress, { size: 20, color: "inherit" }) : _jsx(PlayArrowIcon, {}), disabled: loading ||
                                !isLoggedIn ||
                                !prompt.trim() ||
