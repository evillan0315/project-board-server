  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsx(Typography, {
        ...
        component: 'h1',
        sx: headerSx,
        children: 'Gemini Text-to-Speech Generator',
      }),
      !isLoggedIn &&
        _jsxs(Alert, {
          severity: 'warning',
          sx: { mb: 3 },
          className:
            'bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200 flex items-center justify-between',
          children: [
      ...
      _jsxs(Paper, {
        ...
        children: [
          ...
          _jsx(List, {
            dense: true,
            children: speakers.map((speakerData, index) =>
              _jsxs(
                ListItem,
                {
                  ...
                  children: [
                    _jsx(TextField, {
                      ...
                      onChange: (e) =>
                        ttsStore.updateSpeaker(speakerData.id, 'speaker', e.target.value),
                      variant: 'outlined',
                      size: 'small',
                      disabled: loading || !isLoggedIn,
                      className: 'flex-1',
          ...
          _jsx(Box, {
            ...
            children: _jsx(Button, {
              ...
              children: loading ? 'Generating Speech...' : 'Generate Speech',
            }),
          }),
        ],
      }),
      audioUrl &&
        _jsxs(Paper, {
          ...
          children: [
            ...
            _jsx('audio', { controls: true, src: audioUrl, className: 'w-full' }),
          ],
        }),
    ],
  });
