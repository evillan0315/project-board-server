...
export const LoginPage: React.FC = () => {
  ...
  const handleGoogleLogin = () => {
    window.location.href = `/auth/google?cli_port=${import.meta.env.VITE_FRONTEND_PORT}`;
  };

  const handleGitHubLogin = () => {
    window.location.href = `/auth/github?cli_port=${import.meta.env.VITE_FRONTEND_PORT}`;
  };
