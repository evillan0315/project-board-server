  ...
  switch (prismaType) {
    case 'String':
      ...
      if (!isArray) {
        ...
        validators.push(decorate('IsArray', ''));
        validators.push(decorate('IsString', `${label} must be an array of strings.`, { each: true }));
      }
      break;
    case 'Int':
      tsType = 'number';
      if (!isArray) {
        ...
        validators.push(decorate('IsArray', ''));
        validators.push(decorate('IsInt', `${label} must be an array of integers.`, { each: true }));
      }
      break;
    case 'Float':
      tsType = 'number';
      if (!isArray) {
        ...
        validators.push(decorate('IsArray', ''));
        validators.push(decorate('IsNumber', `${label} must be an array of floats.`, { each: true }));
      }
      break;
    case 'Boolean':
      tsType = 'boolean';
      if (!isArray) {
        ...
        validators.push(decorate('IsArray', ''));
        validators.push(decorate('IsBoolean', `${label} must be an array of booleans.`, { each: true }));
      }
      break;
    case 'DateTime':
      tsType = 'Date';
      if (!isArray) {
        ...
        validators.push(decorate('IsArray', ''));
        validators.push(decorate('IsDate', `${label} must be an array of dates.`, { each: true }));
      }
      break;
    case 'Json':
      tsType = 'any';
      if (!isArray) {
        ...
        validators.push(decorate('IsArray', ''));
        validators.push(decorate('IsObject', `${label} must be an array of objects.`, { each: true }));
      }
      break;
    case 'Decimal':
        tsType = 'string'; 
        if (!isArray) {
          validators.push(decorate('IsString', `${label} must be a string representing a decimal number.`));
        } else {
          validators.push(decorate('IsArray', ''));
          validators.push(decorate('IsString', `${label} must be an array of decimal strings.`, { each: true }));
        }
        break;
    case 'BigInt':
        ...
        if (!isArray) {
          ...
          validators.push(decorate('IsArray', ''));
          validators.push(decorate('IsDefined', `${label} must be an array of big integers.`, { each: true }));
        }
        break;
    case 'Bytes':
        ...
        if (!isArray) {
          ...
          validators.push(decorate('IsArray', ''));
          validators.push(decorate('IsDefined', `${label} must be an array of bytes.`, { each: true }));
        }
        break;
    default:
      tsType = 'string';
