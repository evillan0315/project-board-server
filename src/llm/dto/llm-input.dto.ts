...
export class LlmInputDto {
  ...
  @ApiPropertyOptional({
    description:
      'A high-level overview of the project directory structure, typically generated as a tree string or simplified list. Sent by frontend as empty, generated by backend.',
    example: `
project-root/
├── src/
│   ├── app.module.ts
...
`,
  ...
  @ApiPropertyOptional({
    description:
      'An array of relevant files from the project, including their paths and content, for the LLM to analyze or modify. Sent by frontend as empty, generated by backend.',
    type: [ScannedFileDto],
    isArray: true,
    example: [
      {
  ...
  relevantFiles?: ScannedFileDto[]; // Changed to optional
